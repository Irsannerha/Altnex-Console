          ...
          <div className="footer-news-links d-flex flex-column align-items-left justify-content-left">
            ...
            <Form>
              <Form.Group className="mb-3" controlId="formBasicEmail">
                <div className="form">
                  <img src={svgURI} alt="logo" className="img-svg" />
                  <Form.Control
                    type="email"
            ...
            <Card.Img className="card-ps" src={iconStickTwo} />
          </div>
        </div>
      </Card.Body>
      <Navbar className="navcol">
        <Container>
          <Navbar.Brand className="nav-text-brand" href="/">
            © 2023 ALTNEX CONSOLE. All Rights Reserved.
          </Navbar.Brand>
          <Nav.Link href="/" className="icon-go">
            <Card.Img className="card-go" src={gameOver} />
          </Nav.Link>
          <Nav>
            <Nav.Link href="#deets" className="pripol">
              Privacy Policy
            </Nav.Link>
            <Nav.Link href="#memes" className="term">Terms of Use</Nav.Link>
          </Nav>
          <Navbar.Toggle aria-controls="responsive-navbar-nav" />
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="ms-auto">
              <Nav.Link href="/" className="icon-plane">
                <svg
                  width="48"
                  height="48"
                  viewBox="0 0 48 48"
              ...
              <Nav.Link href="/" className="icon-tiktok">
                <svg
                  width="48"
                  height="48"
                  viewBox="0 0 48 48"
              ...
              <Nav.Link href="/" className="icon-ig">
                <svg
                  width="48"
                  height="48"
                  viewBox="0 0 48 48"
              ...
              <Nav.Link href="/" className="icon-dc">
                <svg
                  width="48"
                  height="41"
                  viewBox="0 0 48 41"
